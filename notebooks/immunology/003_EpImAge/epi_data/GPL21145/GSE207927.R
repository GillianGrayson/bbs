...
# Setting path
###############################################
path_data <- "D:/YandexDisk/Work/pydnameth/datasets/GPL21145/GSE207927"
...
path_work <- "D:/YandexDisk/Work/bbd/immunology/003_EpImAge/epi/GSE207927"
setwd(path_work)
...
# Import data
###############################################
pd <- as.data.frame(read_excel(paste(path_data,"/raw/controls.xlsx", sep="")))
row.names(pd) <- pd$gsm
